...
public class AlgorithmsPage extends LogedInPage {
    ...
    public void insertValueInFormControlFields(String formControl) {
    ...
    public void submitNewValue(String formControl, String searchKey, String vgnKey, String letter) {
