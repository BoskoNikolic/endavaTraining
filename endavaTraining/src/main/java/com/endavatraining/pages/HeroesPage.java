...
public class HeroesPage extends BasePage {
    ...
    public static By messageForHeroAlreadyEx = By.id("nameMessage");
    private By search = By.id("search");
    private By searchIcon = By.xpath("//*[@id=\"custom-search-input\"]/div/span/button/i");
    private By deleteAlreadyExistsHero= By.xpath("//*[@id=\"heroes-table\"]/tbody/tr[1]/td[5]/a[3]");
    private By cancel= By.xpath("//*[@id=\"add-hero-form\"]/div[2]/button[1]");
    ...
    public void openAddNewHero() {
        wait.until(ExpectedConditions.visibilityOfElementLocated(addNewHeroButton));
    ...
    public void addNewHero(String heroName, String level, String className){
        wait.until(ExpectedConditions.visibilityOfElementLocated(addHeroName));
        insertHeroName(heroName);
        insertHeroLevel(level);
        insertHeroClass(className);
    }

    public String getTextOfWarningMessageHeroAlreadyExists() {
        return driver.findElement(messageForHeroAlreadyEx).getText();
    }
    ...
    public void deleteAlreadyExistsHero(){
        wait.until(ExpectedConditions.visibilityOfElementLocated(deleteAlreadyExistsHero));
        driver.findElement(deleteAlreadyExistsHero).click();
    }

    public void clickOnDeleteHero(){
        wait.until(ExpectedConditions.visibilityOfElementLocated(deleteHeroButton));
        driver.findElement(deleteHeroButton).click();
    }
