...
public class TestBrokenLinkPage extends BaseTest {
	...
	/*
	 * Test validates that elements visible on other pages are invisible on Broken
	 * Link page and that page title is shown
	 * 
	 * @author Srboljub.Todorovic
	 */
	...
	public void testBrokenLinkPageIsOpened() {
		...
		Assert.assertTrue(brokenLinkPage.isMainTitlePresent(),
				"The main title of the page isn't presented on the page");
