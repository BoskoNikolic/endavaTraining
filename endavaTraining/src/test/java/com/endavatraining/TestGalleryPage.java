...
public class TestGalleryPage extends BaseTest {
	...
	/**
	 * Test validates that captions of images in Gallery tab exist by logging in as
	 * user, clicking on Gallery tab, clicking on each image and comparing the
	 * captions of images
	 *
	 * @author Jovan.Penic
	 */
	...
	/**
	 * Test validates that User can go through the gallery using right/left slides,
	 * by logging in as user, clicking on Gallery tab, clicking on first image and
	 * comparing the captions of images after clicking on right/left slides
	 *
	 * @author Jovan.Penic
	 */
	@Test
